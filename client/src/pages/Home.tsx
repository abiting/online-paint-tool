        ...
        <section ref={workspaceRef} className="workspace" aria-label={copy.canvasWorkspace}>
          ...
          <footer className="workspace-footer product-footer" aria-label="AbiPaint 工具說明">
            ...
            <div className="product-footer-meta">
              ...
              <div className="product-build-meta" aria-label="AbiPaint version 1.0.6">
                <a className="product-version-label" href={isEnglish ? "/en/guide/" : "/guide/"} title={isEnglish ? "Read the AbiPaint guide" : "閱讀 AbiPaint 使用指南"}>v1.0.6</a>
                <a
